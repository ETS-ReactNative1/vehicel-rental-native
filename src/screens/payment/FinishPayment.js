  ...
  return (
    ...
    {/* <ScrollView> */}
      ...
      <View>
        ...
        <Text style={styles.timerTitle}>Insert your payment code while you transfer booking order
        Pay before : {body.email}{body.name}
        </Text>
      ...
      <View>
        <Text style={styles.infoCode}>Booking code : 
        <Text style={styles.status}>{bookCode.code}</Text>
        </Text>
        <Text style={styles.timerTitle}>Use booking code to pick up your vespa</Text>

      <TouchableOpacity style={styles.FinPay} onPress={() => navigation.navigate('Home')}>
